...
Preprocessed spectroscopy data for one representative participant is provided in ./Data_for_correction/sLaser_preproc and ./Data_for_correction/sLaser_preproc. 
...
Modelling of the water peak and fitting of the underlying metabolites is performed in sLaser_fitting.ipynb and mPress_fitting.ipynb.

GIRF-corrected data is available for all participants in ./Data_for_fitting. 

Final processed outputs used for figures are optioanlly output to ./Data_for_plotting. This step has been completed in full for one participant. 
